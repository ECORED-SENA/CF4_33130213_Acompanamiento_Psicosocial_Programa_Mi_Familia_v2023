  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Construyendo un plan familiar
        p.mb-4 Definir un plan familiar de acompañamiento psicosocial de acuerdo al reconocimiento de temáticas en contextos específicos.
